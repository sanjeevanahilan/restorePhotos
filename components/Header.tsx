...
export default function Header() {
  return (
    /* I want the image centred, how can I do that? */
    // flex justify-between items-center w-full mt-5 border-b-2 pb-7 sm:px-4 px-2
    <header className=" ">
      <Link href="/" className="flex space-x-2">
        <Image
          alt="header text"
          src="/solve_intelligence_logo.jpg"
          className="flex sm:w-[140px] sm:h-[140px] w-9 h-9"
          width={36}
          height={36}
        />
        <h1 className="sm:text-5xl text-3xl font-bold ml-2 tracking-tight">
